  ...
  <section class="crm-benefits" ref="sectionRef">
    ...
    <div class="blob-layer">
      <div class="blob-left" :style="blobLeftStyle">
        <img src="/src/assets/images/blob/blob-left-1.png" alt="" />
      </div>
      <div class="blob-right" :style="blobRightStyle">
        <img src="/src/assets/images/blob/blob-right-1.png" alt="" />
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="dashed-logo-deco" :class="{ 'animate': animateDeco }">
        ...
        <img src="/src/assets/images/glitched-logo.png" alt="" class="glitched-logo" />
        <img src="/src/assets/images/logo-main.png" alt="Uniseller" class="main-logo" />
      </div>
      ...
      <div class="features-grid">
        ...
        <div class="feature-card with-border">
          <img src="/src/assets/images/ico/codicon_settings.svg" alt="" class="feature-icon" />
        ...
        <div class="feature-card">
          <img src="/src/assets/images/ico/tabler_filter.svg" alt="" class="feature-icon" />
        ...
        <!-- Card 3 - no border -->
        <div class="feature-card">
          <img src="/src/assets/images/ico/tabler_users.svg" alt="" class="feature-icon" />
        ...
        <!-- Card 4 - with border -->
        <div class="feature-card with-border">
          <img src="/src/assets/images/ico/ci_settings.svg" alt="" class="feature-icon" />
...
const blobLeftStyle = computed(() => {
  ...
  return {
    transform: `translateY(${offset * 0.18}px)` // Enhanced parallax (was 0.12)
  }
})
...
const handleScroll = () => {
  ...
  // Trigger animation when deco enters viewport
