...
.review-card {
  ...
  /* Убираем contain полностью, так как он блокирует backdrop-filter */
  /* contain: none; - не используем contain для карточек с backdrop-filter */
}
...
@media (max-width: 640px) {
  ...
  /* Исправление: карточки должны занимать 100% ширины на мобильных */
  .slider-outer {
    margin: 0 20px;
    overflow: hidden;
    clip-path: none; /* Убираем clip-path на мобильных */
  ...
  .slider-track {
    gap: 16px;
    width: 100%; /* Убеждаемся что track занимает всю ширину */
    /* Исправление: убираем contain для правильного отображения на мобильных */
    contain: none;
    /* Исправление: flex-shrink для правильного расчета ширины */
    flex-shrink: 0;
  }
  ...
  .review-card {
    ...
    /* Исправление: убираем фиксированную ширину на мобильных */
    flex-shrink: 0;
  }
  .blob-right {
    display: none;
