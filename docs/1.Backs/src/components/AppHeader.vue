  ...
  <header class="header">
    <div class="glass-panel">
      ...
      <ul class="nav-menu" :class="{ 'mobile-open': mobileMenuOpen }">
        <!-- Решения dropdown -->
        <li class="nav-item dropdown" @mouseenter="openDropdown('solutions')" @mouseleave="closeDropdown('solutions')">
          <a href="#" class="nav-link" @click.prevent>
            Решения
            <svg 
              class="chevron" 
              :class="{ 'rotated': openedDropdown === 'solutions' }"
              width="12" 
              height="8" 
              viewBox="0 0 12 8" 
              fill="none"
        ...
        <!-- Продукты dropdown -->
        <li class="nav-item dropdown" @mouseenter="openDropdown('products')" @mouseleave="closeDropdown('products')">
          <a href="#" class="nav-link" @click.prevent>
            Продукты
            <svg 
              class="chevron" 
              :class="{ 'rotated': openedDropdown === 'products' }"
              width="12" 
              height="8" 
              viewBox="0 0 12 8" 
              fill="none"
